...
namespace BTTN4KNFE
{
	...
	public class BTTN4KNFEFactory
	{
		...
		public static string FillTemplate(NFTAppV9.Droid.MainActivity activity, BTTN4KNFEValues nfeValues)
		{
			string nfeJson = "";
			...
			{
				int proof4 = NFTAppV9.Droid.Resource.Raw.proof4;
				int envelope4 = NFTAppV9.Droid.Resource.Raw.envelope4;
		...
		//Something here isnt working with the permissions
